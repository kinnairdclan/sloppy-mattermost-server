...
ARG PUID=2000
ARG PGID=2000
ARG MM_PACKAGE="https://releases.mattermost.com/${VERSION}/mattermost-team-${VERSION}-linux-amd64.tar.gz?src=docker"
...
WORKDIR /mattermost
CMD ["mattermost", "--config=/mattermost/data/config.json"]
